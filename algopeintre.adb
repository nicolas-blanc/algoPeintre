...
procedure algopeintre is 
	...
	--Exception
	--Exception levé si le nombre d'arguments à l'appel de la fonction est incorrect
...
exception
	when lectureoff.NBR_LIGNES_ERROR => Put_line("Fin du programme avec une erreur NBR_LIGNES_ERROR");
	when tri_paquets.INSERTION_ERROR => Put_line("Fin du programme avec une erreur INSERTION_ERROR");
